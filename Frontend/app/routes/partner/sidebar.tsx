...
const PartnerSidebar: React.FC<SidebarProps> = ({
  ...
  const mainPages = partnerPages.filter(page => page.label !== "Profile" && page.label !== "Settings");
  const profilePage = partnerPages.find(page => page.label === "Profile");
  const settingsPage = partnerPages.find(page => page.label === "Settings");
