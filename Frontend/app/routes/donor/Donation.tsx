  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = {
        ...
        method: "CREDIT_CARD",
        name: form.name,
        email: form.anonymous ? "anonymous@gmail.com" : form.email,
        phone: form.phone,
      ...
      >
        ...
        <div className="mt-2 bg-blue-50 rounded-3xl px-6 py-8 relative">
          <div className="flex gap-4 mb-6">
            <button
              type="button"
              className={`flex-1 flex flex-col items-center justify-center py-3 rounded-xl border-2 font-bold shadow-sm transition-all ${paymentMethod === "card" ? "border-blue-500 bg-white text-blue-700" : "border-gray-200 bg-white text-gray-400"}`}
              onClick={() => setPaymentMethod("card")}
            >
              <svg
                className={`h-6 w-6 mb-1 ${paymentMethod === "card" ? "text-blue-500" : "text-gray-400"}`}
                fill="none"
                stroke="currentColor"
                strokeWidth={2}
                viewBox="0 0 24 24"
            ...
            <button
              type="button"
              className={`flex-1 flex flex-col items-center justify-center py-3 rounded-xl border-2 font-bold shadow-sm transition-all ${paymentMethod === "eps" ? "border-blue-500 bg-white text-blue-700" : "border-gray-200 bg-white text-gray-400"}`}
            ...
            <button
              type="button"
              className={`flex-1 flex flex-col items-center justify-center py-3 rounded-xl border-2 font-bold shadow-sm transition-all ${paymentMethod === "giropay" ? "border-blue-500 bg-white text-blue-700" : "border-gray-200 bg-white text-gray-400"}`}
            ...
            <button
              type="button"
              className={`flex flex-col items-center justify-center px-4 py-3 rounded-xl border-2 font-bold shadow-sm transition-all ${paymentMethod === "more" ? "border-blue-500 bg-white text-blue-700" : "border-gray-200 bg-white text-gray-400"}`}
              onClick={() => {
          ...
          <div className="mb-4">
            ...
            {paymentMethod === "eps" && (
              <div className="flex flex-col items-center justify-center py-8">
                <span className="text-lg text-gray-500">
                  EPS payment is not yet available in this demo.
                </span>
              </div>
            )}
            {paymentMethod === "giropay" && (
              <div className="flex flex-col items-center justify-center py-8">
                <span className="text-lg text-gray-500">
                  Giropay payment is not yet available in this demo.
                </span>
              </div>
            )}
