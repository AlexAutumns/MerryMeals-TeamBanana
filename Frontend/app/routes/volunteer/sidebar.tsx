...
const VolunteerSidebar: React.FC<SidebarProps> = ({
  ...
  const mainPages = volunteerPages.filter(page => page.label !== "Profile" && page.label !== "Settings");
  const profilePage = volunteerPages.find(page => page.label === "Profile");
  const settingsPage = volunteerPages.find(page => page.label === "Settings");
